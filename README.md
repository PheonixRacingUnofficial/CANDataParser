...
parser = Parser("path/to/sensor_file.txt")
...
- [`Parser`](fpu_can_parser/parser/documentation/Parser.md): Handles CAN line format parsing, timestamp normalization, and sensor value decoding.
- [`SensorManager`](fpu_can_parser/parser/documentation/SensorManager.md): Loads and manages all defined sensors and routes CAN data appropriately.
- [`Sensor`](fpu_can_parser/parser/documentation/Sensor.md): Defines individual sensors, their format codes, and how to parse data for each.
- [`SensorAlias`](fpu_can_parser/parser/documentation/SensorAlias.md): Provides definitions for abbreviations used in sensor names and data descriptions.
